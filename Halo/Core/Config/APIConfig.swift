...
enum AppConstants {
    ...
    static let supportEmail = "support@haloapp.com"
    static let privacyPolicyURL = URL(string: "https://haloapp.com/privacy")!
    static let termsOfServiceURL = URL(string: "https://haloapp.com/terms")!
}

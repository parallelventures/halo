...
extension LinearGradient {
    ...
    static let eclatMesh = LinearGradient(
        colors: [
...
extension RadialGradient {
    static let eclatGlow = RadialGradient(
        colors: [
...
extension Font {
    static let eclat = EclatTypography()
}

struct EclatTypography {
    // Display - Bold for glass contrast
    let displayLarge = Font.custom("GTAlpinaTrial-CondensedThin", size: 40)
    let displayMedium = Font.custom("GTAlpinaTrial-CondensedThin", size: 32)
    let displaySmall = Font.custom("GTAlpinaTrial-CondensedThin", size: 28)
...
#Preview("Theme Colors") {
    ...
    .background(LinearGradient.eclatBackground)
}
